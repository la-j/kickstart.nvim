      ...
      require('which-key').setup {
        icons = {
          ...
          keys = {
            ...
            CR = '↵',
            Esc = 'Esc',
            ScrollWheelDown = 'Scrl Up',
            ScrollWheelUp = 'Scrl Dn',
            NL = 'NL',
            BS = 'BS',
            Space = 'Space',
            Tab = 'Tab',
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        ...
        additional_vim_regex_highlighting = { 'ruby', 'elixir', 'eex' },
      },
      indent = { enable = true, disable = { 'ruby', 'elixir', 'eex' } },
    },
